...
3. **海外主体所在国家** - 海外主体的具体国家或地区
4. **是否有进出口业务** - 企业是否从事跨境贸易
5. **进出口业务涉及国家** - 进出口贸易涉及的国家或地区
6. **进出口主要模式** - 贸易模式（如一般贸易、加工贸易等）
7. **年进出口金额** - 年度进出口贸易额
8. **企业所属行业** - 企业主营业务所属行业
9. **企业年营收规模** - 企业年度营业收入规模
10. **综合总结** - 企业跨境业务的整体概况
...
1. **获取 API Key**
   ...
   - 百度千帆 API Key：[https://console.bce.baidu.com/](https://console.bce.baidu.com/)
...
- 处理完成后点击"下载结果 Excel"
- 结果包含 10 个字段 + 10 个备注列 + 3 个公共列（企业名称、证据条数、来源URL）
- 共 23 列，结构清晰，便于分析

### 输出示例

| 企业名称 | 是否有香港主体 | 是否有香港主体_notes | 是否有进出口业务 | 是否有进出口业务_notes | ... | 证据条数 | 来源URL |
|---------|--------------|---------------------|----------------|----------------------|-----|---------|---------|
